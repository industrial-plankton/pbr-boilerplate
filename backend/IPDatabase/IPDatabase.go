...
func Delete(mysqlDB *sqlx.DB, table, primaryIndex string) error { //deletes row matching given primaryIndex
...
func UpdateOrAdd(mysqlDB *sqlx.DB, table string, headerMap *bimap.BiMap, data [][]interface{}, headerValues []interface{}) error { //adds or updates depending on the primary keys existing
